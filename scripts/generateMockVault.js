...
const generateQuestions = () => {
  ...
  addBlock('NEET', 'Biology', 61, [
    ...
    {q: 'Cranic nerves in humans?', o: ['12 pairs', '10 pairs', '14 pairs', '8 pairs'], c: 0},
  ...
  const output = `export interface ArenaQuestion {
  id: string;
  class_level: string;
  subject: string;
...
\`;
  ...
  fs.writeFileSync('src/data/mockQuestionsPool.ts', output);
