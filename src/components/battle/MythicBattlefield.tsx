...
export default function MythicBattlefield({ playerHp, oppHp, maxHp, attackAnimation, arjunaImageSrc, karnaImageSrc }: MythicBattlefieldProps) {
  ...
  return (
    <div className="relative w-full h-[350px] overflow-hidden rounded-3xl border border-amber-500/30 bg-[#0a0a0a] shadow-[0_0_50px_rgba(245,158,11,0.15)] flex-shrink-0">
      ...
      <div className="relative z-10 h-full flex flex-col md:flex-row justify-center items-center gap-4 md:gap-12 w-full px-4 sm:px-12 pb-8">
        ...
        <div className="relative flex flex-col items-center justify-end w-auto">
          <motion.div animate={attackAnimation === 'player' ? { x: [0, 20, 0] } : {}} transition={{ duration: 0.3 }} className="w-full">
              ...
              <img src={arjunaImageSrc || "/assets/mythic-battle.jpg"} alt="Arjuna" className="h-48 md:h-72 w-auto object-contain shadow-[0_0_30px_rgba(34,211,238,0.5)] border-2 border-cyan-500/50 rounded-xl bg-black/50" />
          </motion.div>
        ...
        <div className="relative flex flex-col items-center justify-end w-auto">
          <motion.div animate={attackAnimation === 'enemy' ? { x: [0, -20, 0] } : {}} transition={{ duration: 0.3 }} className="w-full">
              ...
              <img src={karnaImageSrc || "/assets/mythic-battle.jpg"} alt="Karna" className="h-48 md:h-72 w-auto object-contain shadow-[0_0_30px_rgba(225,29,72,0.5)] border-2 border-rose-500/50 rounded-xl bg-black/50" />
          </motion.div>
