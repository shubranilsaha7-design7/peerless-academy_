  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950 flex flex-col font-sans text-white pb-[env(safe-area-inset-bottom)]">
      ...
      <main className="flex-1 p-6 overflow-y-auto space-y-6">
        ...
        <button onClick={onQuickMatch} className="w-full relative overflow-hidden group p-6 rounded-3xl border border-indigo-500/30 bg-gradient-to-br from-slate-900 to-slate-950 text-left">
